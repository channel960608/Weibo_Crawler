...
class SearchByKeywordItem(scrapy.Item):
    ...
    multi_attitude_1 = scrapy.Field()
    multi_attitude_2 = scrapy.Field()
    multi_attitude_3 = scrapy.Field()
    multi_attitude_4 = scrapy.Field()
    multi_attitude_5 = scrapy.Field()
    multi_attitude_6 = scrapy.Field()
    pic = scrapy.Field()
